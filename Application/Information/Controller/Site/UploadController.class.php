<?php
namespace Information\Controller\Site;
...
class UploadController extends FController {
	...
	public function uploadExcelAction(){ 
	    ...
	    $upload->exts      =     array('jpg','gif','png','jpeg','mp4','flv','avi','wmv','mkv','3gp','swf','xls','xlsx');// 设置附件上传类型
	    $upload->rootPath  =     UPLOAD_PATH;  // 设置附件上传根目录
	...
	public function uploadVideoAction(){
		...
		$upload->exts      =     array('mp4','flv','avi','wmv','mkv','3gp','swf');// 设置附件上传类型
		$upload->rootPath  =     UPLOAD_PATH;  // 设置附件上传根目录
