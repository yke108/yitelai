...
class FController extends Controller {
	...
	protected $sys_id = 2;
	protected $org_id = 0;
	protected $distributor_info = array();
	...
	public function _initialize(){
		...
		//获取分销商的名称
		$this->distributor_info=$this->distributorService()->getInfo(session('org_id'));
		session('distributor_name',$this->distributor_info['distributor_name']);
	...
	protected function settingForAll(){
		session(array('prefix'=>'distributor'));
		cookie(array('prefix'=>'distributor_'));
    ...
    private function orderCount(){
    	...
    	return $this->orderService()->getAdminOrderCount($params);
    }
