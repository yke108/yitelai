...
class OrderController extends FController {
    ...
    public function indexAction($distributor_id = 0){
	...
	public function sheAction($id = 0){
		...
		if(IS_POST){
			...
			$this->success('修改成功',session('back_url'),0);
		}
	...
	public function addAction($distributor_id = 0){
		if(IS_POST){
			$params = I('post.');
	...
	public function delAction($id = 0){
		...
		$this->success('删除成功',session('back_url'),0);
	}
