...
class ShopController extends BaseController
{
    ...
    public function indexAction()/*分析-店铺列表*/
    {
        $content = I('content');
    ...
    public function shopanalysisAction()/*店铺分析*/
    {
        ...
        $this->assign('distributor_id', $shop_id);
        $this->assign('province', $province);
        $this->assign('city', $city);
        $this->assign('province_city_area', $province_city_area);

        $distributorInfoFind = $this->distributorInfoService()->distributorInfoFind($shop_id);
        ...
        $diffVisitorValue = diffValue($visitorAskFrontCount - $visitorAskToCount);
        //end 访客数
