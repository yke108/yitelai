...
class InquiryModel extends Model{
	...
	protected $_validate = array(
			array('user_name','require','姓名不能为空'), //默认情况下用正则进行验证
			array('mobile','require','电话不能为空'), //默认情况下用正则进行验证
			array('region_code','require','地区不能为空'), //默认情况下用正则进行验证
			array('content','require','需求内容不能为空'), //默认情况下用正则进行验证
	);
