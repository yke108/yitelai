...
class AuthorModel extends RelationModel {
    protected $trueTableName = 'info_news_author';
    
    protected $_validate = array(
    		array('author_img','require','头像不能为空',1),
    		array('author_name','require','姓名不能为空',1),
    );
    ...
    public function searchFieldRecords($map, $field = 'author_id, author_img, author_name'){
