...
class AccountModel extends Model{
	...
	protected $tableName = 'distributor_account';
	protected $pk = 'distributor_id';
	
	public function getFieldRecord($map,$field='id,distributor_id,amount_old,amount_change,change_desc,change_type'){
    ...
    public function searchRecordsSum($map){
		return $this->where($map)->sum('amount_change');
    }
