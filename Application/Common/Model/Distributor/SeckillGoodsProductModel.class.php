...
class SeckillGoodsProductModel extends RelationModel {
    protected $tableName = 'seckill_distributor_goods_product';
	...
	public function getRecord($id){
   		return $this->alias('a')->field('b.*, a.*')
        		->join('LEFT JOIN __DISTRIBUTOR_GOODS_PRODUCT__ b ON b.id=a.distributor_product_id')
   				->find($id);
	}
	...
	public function searchRecords($map, $orderBy, $start, $limit){
        return $this->alias('a')->field('c.*, b.*, a.*')
        		->join('LEFT JOIN __DISTRIBUTOR_GOODS_PRODUCT__ b ON b.id=a.distributor_product_id')
        		->join('LEFT JOIN __GOODS_PRODUCT__ c ON c.product_id=b.product_id')
